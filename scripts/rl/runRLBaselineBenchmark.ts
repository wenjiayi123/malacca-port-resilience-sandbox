...
触发小分母门禁，\`relativePercentClaimAllowed=${relativePercentClaimAllowed}\`；这些百分比不作为摘要指标。
...
- 旧版 66% 报告保留在 \`reports/rl-benchmark-balanced-resilience.md\`，只作为校准前历史对照，不作为当前基准结果。
`;
