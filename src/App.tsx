...
const rlTrainingStages: RlTrainingStage[] = [
  ...
  },
  {
    ...
    rangeStart: 8,
    rangeEnd: 18,
    detail: '从训练记录构造排队、延误、碳强度、气象风险状态与五类控制动作。',
  ...
  },
  {
    ...
    rangeStart: 18,
    rangeEnd: 72,
    detail: 'Q-Learning、SARSA、Expected SARSA 与 Dyna-Q 读取训练段，逐 episode 更新价值函数。',
    output: 'q_tables',
    tone: 'ok',
  },
  {
...
export function App() {
  ...
  const rlTrainingDynamicLogs = rlTrainingJob?.logs.length
    ...
    : [
        ...
        `奖励配置：delay ${rlTrainingRewardWeights.delay.toFixed(2)} / congestion ${rlTrainingRewardWeights.congestion.toFixed(2)} / carbon ${rlTrainingRewardWeights.carbon.toFixed(2)} / safety ${rlTrainingRewardWeights.safety.toFixed(2)}`,
      ];
  ...
  const selectRlTrainingObjective = (objectiveId: RlTrainingObjectiveId) => {
    ...
    setSandboxRuntime((runtime) => ({
      ...
      rlTraining: {
        ...
        backend: {
          ...runtime.rlTraining.backend,
          lastMessage: `训练优化目标已切换为「${selectedObjective.label}」，请重新同步参数或启动训练。`,
        },
      },
    }));
                ...
                {!isRlTrainingCardClosed('parameters') && (
                  ...
                  >
                    <label className="rl-objective-select">
                      ...
                      <small>{activeRlTrainingObjective.rewardFocus}</small>
                    </label>
                    ...
                    <div className="rl-training-contract">
                      ...
                      <span>
                        ...
                        <strong>
                          ...
                          {formatRlParameterValue('seed', activeRlTrainingRequest.trainingParameters.seed)}
                        </strong>
                      </span>
                      <span>
                      ...
                      <span>
                        ...
                        <strong>
                          ...
                          {activeRlTrainingRequest.rewardWeights.safety}
                        </strong>
                      </span>
                    </div>
                  </RlTrainingCard>
